...
public class PoCoParser extends Parser {
	...
	public final MacrodeclContext macrodecl() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				setState(328); idlist(0);
				setState(329); match(RPAREN);
				setState(330); match(LBRACKET);
				setState(331); match(LTICK);
				setState(332); re(0);
				setState(333); match(APOSTROPHE);
				setState(334); match(RBRACKET);
				setState(335); match(COLON);
				setState(336); match(RETYPE);
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(338); match(AT);
				setState(339); id();
				setState(340); match(LPAREN);
				setState(341); idlist(0);
				setState(342); match(RPAREN);
				setState(343); match(LBRACKET);
				setState(344); match(BOOLUOP);
				setState(345); match(LTICK);
				setState(346); re(0);
				setState(347); match(APOSTROPHE);
				setState(348); match(RBRACKET);
				setState(349); match(COLON);
				setState(350); match(RETYPE);
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(352); match(AT);
				setState(353); id();
				setState(354); match(LPAREN);
				setState(355); match(RPAREN);
				setState(356); match(LBRACKET);
				setState(357); srecase(0);
				setState(358); match(RBRACKET);
				setState(359); match(COLON);
				setState(360); match(SRETYPE);
				}
				break;
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(362); match(AT);
				setState(363); id();
			...
			case 7:
				...
				setState(377); match(LTICK);
				setState(378); re(0);
				setState(379); match(APOSTROPHE);
				setState(380); match(RBRACKET);
				setState(381); match(COLON);
				setState(382); match(RETYPE);
				}
				break;
			case 8:
				enterOuterAlt(_localctx, 8);
				{
				setState(384); match(AT);
				setState(385); id();
				setState(386); match(LPAREN);
				setState(387); match(RPAREN);
				setState(388); match(LBRACKET);
				setState(389); match(BOOLUOP);
				setState(390); match(LTICK);
				setState(391); re(0);
				setState(392); match(APOSTROPHE);
				setState(393); match(RBRACKET);
				setState(394); match(COLON);
				setState(395); match(RETYPE);
				}
				break;
			}
		}
	...
	public final VardeclContext vardecl() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(409); match(VAR);
				setState(410); id();
				setState(411); match(COLON);
				setState(412); match(RETYPE);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(414); match(VAR);
				setState(415); id();
				setState(416); match(COLON);
				setState(417); match(SRETYPE);
				}
				break;
			}
		}
	...
	private SrecaseContext srecase(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(422); matchs(0);
				setState(423); match(ARROW);
				setState(424); sre();
				}
				break;
			case 2:
				{
				setState(426); match(AT);
				setState(427); id();
				setState(428); match(LBRACKET);
				setState(429); match(LTICK);
				setState(430); re(0);
				setState(431); match(APOSTROPHE);
				setState(432); match(RBRACKET);
				}
				break;
			}
			_ctx.stop = _input.LT(-1);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(436);
					if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
					setState(437); match(BAR);
					setState(438); matchs(0);
					setState(439); match(ARROW);
					setState(440); sre();
					}
					} 
				}
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(493); match(BAR);
						setState(494); execution(5);
						}
						break;
					case 2:
						{
	...
	public final ExchContext exch() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(527); match(OPEN);
				setState(528); matchs(0);
				setState(529); match(ARROW);
				setState(530); sre();
				setState(531); match(CLOSE);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(533); match(OPEN);
				setState(534); match(INPUTWILD);
				setState(535); match(ARROW);
				setState(536); sre();
				setState(537); match(CLOSE);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(539); match(DOLLAR);
				setState(540); id();
				}
				break;
			case 4:
	...
	public final ObjectContext object() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(566); match(POUND);
				setState(567); qid(0);
				setState(568); match(LBRACE);
				setState(569); re(0);
				setState(570); match(RBRACE);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(572); match(NULL);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(573); match(DOLLAR);
				setState(574); id();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(575); match(POUND);
				setState(576); qid(0);
				setState(577); match(LBRACE);
				setState(578); fieldlist(0);
	...
	private MatchsContext matchs(int _p) throws RecognitionException {
		...
		try {
			...
			case BOOLUOP:
				{
				setState(599); match(BOOLUOP);
				setState(600); matchs(4);
				}
				break;
			case LPAREN:
				{
				setState(601); match(LPAREN);
				setState(602); matchs(0);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(608);
					if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
					setState(609); match(BOOLBOP);
					setState(610); matchs(4);
					}
					} 
				}
				setState(615);
	...
	public final MatchContext match() throws RecognitionException {
		...
		try {
			...
			case AT:
				enterOuterAlt(_localctx, 2);
				{
				setState(617); match(AT);
				setState(618); id();
				setState(619); match(LBRACKET);
				setState(620); match(LTICK);
				setState(621); re(0);
				setState(622); match(APOSTROPHE);
				setState(623); match(RBRACKET);
				}
				break;
			case SUBSET:
				enterOuterAlt(_localctx, 3);
				{
				setState(625); match(SUBSET);
	...
	public final IreContext ire() throws RecognitionException {
		...
		try {
			...
			case ACTION:
				enterOuterAlt(_localctx, 1);
				{
				setState(646); match(ACTION);
				setState(647); match(LPAREN);
				setState(648); match(LTICK);
				setState(649); re(0);
				setState(650); match(APOSTROPHE);
			...
			case RESULT:
				enterOuterAlt(_localctx, 2);
				{
				setState(653); match(RESULT);
				setState(654); match(LPAREN);
				setState(655); match(LTICK);
				setState(656); re(0);
				setState(657); match(APOSTROPHE);
				setState(658); match(COMMA);
				setState(659); match(LTICK);
				setState(660); re(0);
				setState(661); match(APOSTROPHE);
				setState(662); match(RPAREN);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final SreContext sre() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				consume();
				setState(667); match(LTICK);
				setState(668); re(0);
				setState(669); match(APOSTROPHE);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(671); match(NEUTRAL);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(676); match(DOLLAR);
				setState(677); qid(0);
				setState(678); match(LPAREN);
			...
			case 8:
				enterOuterAlt(_localctx, 8);
				{
				setState(695); match(FOLD);
				setState(696); match(LPAREN);
				setState(697); match(DOLLAR);
				setState(698); id();
				setState(699); match(COMMA);
				setState(700); match(DOLLAR);
				setState(701); id();
	...
	public final SrebopContext srebop() throws RecognitionException {
		...
		try {
			...
			case SREUNION:
				enterOuterAlt(_localctx, 1);
				{
				setState(718); sreunion();
				}
				break;
			case SRECONJ:
				enterOuterAlt(_localctx, 2);
				{
				setState(719); sreconj();
				}
				break;
			case SREDISJ:
				enterOuterAlt(_localctx, 3);
				{
				setState(720); sredisj();
				}
				break;
			case SREEQUALS:
				enterOuterAlt(_localctx, 4);
				{
				setState(721); sreequals();
				}
				break;
			case SREPUNION:
				enterOuterAlt(_localctx, 5);
				{
				setState(722); srepunion();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final SreuopContext sreuop() throws RecognitionException {
		...
		try {
			...
			case SRECOMP:
				enterOuterAlt(_localctx, 1);
				{
				setState(735); srecomp();
				}
				break;
			case SREACTIONS:
				enterOuterAlt(_localctx, 2);
				{
				setState(736); sreactions();
				}
				break;
			case SRERESULTS:
				enterOuterAlt(_localctx, 3);
				{
				setState(737); sreresults();
				}
				break;
			case SREPOS:
				enterOuterAlt(_localctx, 4);
	...
	private ReContext re(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(776); opparamlist(0);
				setState(777); match(RPAREN);
				}
				break;
			case 3:
				{
				setState(779); match(DOLLAR);
				setState(780); qid(0);
				}
				break;
			case 4:
				{
				setState(781); function();
				}
				break;
			case 5:
				{
			...
			case 7:
				{
				setState(787); match(LPAREN);
				setState(788); match(RPAREN);
				}
				break;
			case 8:
				{
				setState(789); match(AT);
				setState(790); id();
				setState(791); match(LBRACKET);
				setState(792); re(0);
				setState(793); match(RBRACKET);
				}
				break;
			case 9:
				{
				setState(795); match(INIT);
				}
				break;
			case 10:
				{
	...
	public final FunctionContext function() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(814); fxnname();
				setState(815); match(INIT);
				setState(816); match(LPAREN);
				setState(817); arglist(0);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(820); fxnname();
				setState(821); match(LPAREN);
				setState(822); arglist(0);
	...
	public static final String _serializedATN =
		...
		"\u01ef\f\6\2\2\u01ef\u01f0\7\16\2\2\u01f0\u01f8\5*\26\7\u01f1\u01f2\f"+
		"\b\2\2\u01f2\u01f8\5*\26\2\u01f3\u01f4\f\5\2\2\u01f4\u01f8\7\7\2\2\u01f5"+
		"\u01f6\f\4\2\2\u01f6\u01f8\7\20\2\2\u01f7\u01ee\3\2\2\2\u01f7\u01f1\3"+
