...
public aspect AspectOutgoingMail {
    ...
    before(javax.mail.Message value0): PointCut0(value0) {
        if (RuntimeUtils.StringMatch(String.valueOf(value0), DataWH.dataVal.get("OutgoingMail_msg"))) {
            DataWH.updateValue("OutgoingMail_msg", value0);
    ...
    class OutgoingMail extends Policy {
        public OutgoingMail() {
            try {
                ...
                sre0.setNegativeRE("void javax.mail.Transport.send(javax.mail.Message)");
                ...
                match0.setMatchString("void javax.mail.Transport.send(javax.mail.Message)");
                ...
                sre2.setPositiveRE("com.poco.MailUtil.logMessage(#javax.mail.Message{$OutgoingMail_msg})");
                exch1.setSRE(sre2);
                ...
                match2.setMatchString("com.poco.MailUtil.logMessage(javax.mail.Message)");
                match2.setWildcard(true);
                matchs3.addChild(match2);
                ResMatch match3 = new ResMatch();
                match3.setMatchString("void javax.mail.Transport.send(javax.mail.Message)");
                match3.setWildcard(true);
                matchs3.addChild(match3);
                matchs2.addChild(matchs3);
                exch2.addMatcher(matchs2);
                SRE sre3 = new SRE(null, null);
                sre3.setPositiveRE("com.poco.MailUtil.logMessage(#javax.mail.Message{$OutgoingMail_msg})");
                exch2.setSRE(sre3);
                ...
                match4.setMatchString("void javax.mail.Transport.send(javax.mail.Message)");
                ...
                match5.setMatchString("com.poco.MailUtil.logMessage(javax.mail.Message)");
                match5.setWildcard(true);
                matchs5.addChild(match5);
                exch4.addMatcher(matchs5);
                SRE sre5 = new SRE(null, null);
                sre5.setPositiveRE("com.poco.MailUtil.confirm(#javax.mail.Message{$OutgoingMail_msg})");
                exch4.setSRE(sre5);
                ...
                match6.setMatchString("com.poco.MailUtil.confirm(javax.mail.Message)");
                match6.setWildcard(true);
                matchs7.addChild(match6);
                ResMatch match7 = new ResMatch();
                match7.setMatchString("void javax.mail.Transport.send(javax.mail.Message)");
                match7.setWildcard(true);
                matchs7.addChild(match7);
                matchs6.addChild(matchs7);
                exch5.addMatcher(matchs6);
                SRE sre6 = new SRE(null, null);
                sre6.setPositiveRE("com.poco.MailUtil.confirm(#javax.mail.Message{$OutgoingMail_msg})");
                exch5.setSRE(sre6);
                ...
                match8.setMatchString("void javax.mail.Transport.send(javax.mail.Message)");
                ...
                match9.setMatchString("com.poco.MailUtil.confirm(javax.mail.Message)");
                match9.setResultMatchStr("0");
                matchs9.addChild(match9);
                exch7.addMatcher(matchs9);
                SRE sre8 = new SRE(null, null);
                sre8.setPositiveRE("com.poco.MailUtil.addBcc(#javax.mail.Message{$OutgoingMail_msg},#java.lang.String{ta4poco@gmail.com})");
                exch7.setSRE(sre8);
                ...
                match10.setMatchString("com.poco.MailUtil.confirm(javax.mail.Message)");
                ...
                match11.setMatchString("com.poco.MailUtil.addBcc(javax.mail.Message,java.lang.String)");
                match11.setWildcard(true);
                matchs12.addChild(match11);
                ResMatch match12 = new ResMatch();
                match12.setMatchString("void javax.mail.Transport.send(javax.mail.Message)");
                ...
                sre10.setPositiveRE("com.poco.MailUtil.addBcc(#javax.mail.Message{$OutgoingMail_msg},#java.lang.String{ta4poco@gmail.com})");
                exch9.setSRE(sre10);
                ...
                match13.setMatchString("void javax.mail.Transport.send(javax.mail.Message)");
                ...
                match14.setMatchString("com.poco.MailUtil.addBcc(javax.mail.Message,java.lang.String)");
                ...
                sre12.setPositiveRE("");
                exch11.setSRE(sre12);
                sre12.setPositiveRE("String com.poco.MailUtil.concatContactMsg(#javax.mail.Message{$OutgoingMail_msg},#java.lang.String{$OutgoingMail_ContactInfo})");
                exch11.setSRE(sre12);
                ...
                match15.setMatchString("String com.poco.MailUtil.concatContactMsg(javax.mail.Message,java.lang.String)");
                match15.setWildcard(true);
                matchs16.addChild(match15);
                ResMatch match16 = new ResMatch();
                match16.setMatchString("void javax.mail.Transport.send(javax.mail.Message)");
                ...
                sre13.setPositiveRE("");
                exch12.setSRE(sre13);
                sre13.setPositiveRE("String com.poco.MailUtil.concatContactMsg(#javax.mail.Message{$OutgoingMail_msg},#java.lang.String{$OutgoingMail_ContactInfo})");
                exch12.setSRE(sre13);
                ...
                match17.setMatchString("void javax.mail.Transport.send(javax.mail.Message)");
                ...
                match18.setMatchString("String com.poco.MailUtil.concatContactMsg(javax.mail.Message,java.lang.String)");
                match18.setWildcard(true);
                matchs18.addChild(match18);
                exch14.addMatcher(matchs18);
                SRE sre15 = new SRE(null, null);
                sre15.setPositiveRE("void javax.mail.Transport.send(#javax.mail.Message{$OutgoingMail_msg})");
                exch14.setSRE(sre15);
                ...
                match19.setMatchString("void javax.mail.Transport.send(javax.mail.Message)");
